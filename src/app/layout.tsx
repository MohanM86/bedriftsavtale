...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    title: "Bedriftsavtale.no – Norges største portal for bedriftsavtaler",
  ...
  return (
    <html lang="nb">
      ...
      <body>
        ...
        <a
          href="#main-content"
          className="sr-only focus:not-sr-only focus:fixed focus:top-4 focus:left-4 focus:z-50 focus:bg-teal-500 focus:text-white focus:px-4 focus:py-2 focus:rounded-lg focus:text-sm focus:font-bold"
        >
          Hopp til innhold
        </a>
        <Header />
