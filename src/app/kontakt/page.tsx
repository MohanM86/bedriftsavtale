          ...
          <div className="space-y-6">
            <div>
              ...
              <div className="space-y-3">
                <a
                  href="tel:22000000"
                  className="flex items-center gap-4 p-4 bg-teal-50 rounded-2xl border border-teal-100 hover:bg-teal-100 transition-colors group"
                >
                ...
                <a
                  href="mailto:post@bedriftsavtale.no"
                  className="flex items-center gap-4 p-4 bg-[var(--bg)] rounded-2xl border border-[var(--border)] hover:bg-teal-50 hover:border-teal-200 transition-colors group"
                >
