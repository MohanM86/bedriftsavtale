      ...
      <div className="bg-[var(--bg)] border-b border-[var(--border)]">
        <div className="container-site py-8">
          ...
          <h1 className="text-2xl font-extrabold text-[var(--text)] mt-4 mb-2 tracking-tight">
            Bedriftsavtaler for alle størrelser
          </h1>
          <p className="text-sm text-[var(--muted)] max-w-xl">
            Behovet for bedriftsavtaler varierer avhengig av om du er soloselvstending, vekststartup eller etablert bedrift. Finn det som passer for deg.
          </p>
        </div>
      </div>
