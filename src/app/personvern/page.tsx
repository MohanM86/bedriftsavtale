    ...
    <div>
      ...
      <div className="container-site py-10 max-w-2xl">
        <div className="prose-portal space-y-2">
          ...
          <h2>Cookies</h2>
          <p>Vi bruker nødvendige informasjonskapsler for å drive nettsiden. Vi bruker også analysecookies (Google Analytics) for å forstå brukeratferd, med anonymisert IP.</p>
