      ...
      <div className="container-site py-10">
        <div className="grid lg:grid-cols-3 gap-10">
          <div className="lg:col-span-2 prose-portal space-y-2">
            ...
            <h2>Hva vi dekker</h2>
            <p>Portalen dekker hele spekteret av avtaler norske bedrifter typisk trenger: kommunikasjon (mobil, bredbånd), energi (strøm), finans (bedriftskort, regnskap), forsikring, transport (bil, drivstoff, fly, hotell), lokaler, IT og programvare, HR og personal og mye mer.</p>
            ...
            <h2>Kontakt oss</h2>
            <p>Spørsmål, innspill eller vil du samarbeide med oss? Ta kontakt via telefon eller e-post. Vi svarer raskt.</p>
          </div>
